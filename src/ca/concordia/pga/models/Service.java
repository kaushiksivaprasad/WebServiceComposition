...
public class Service extends UniNameObject {
	...
	private Integer score; //use in integer version heuristic function
	private Float scorefp; //use in float point version heuristic function
	...
	public Float getScorefp() {
		return scorefp;
	}

	public void setScorefp(Float scorefp) {
